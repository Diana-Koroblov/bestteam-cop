...
NOT PART OF THE MESSAGE. Stripped from the .txt; these are notes to us.
  ...
  1. Fill in <TEAM NAME> everywhere before sending. Send from itay.malich2@gmail.com.
...
Subject: bestteam ↔ <TEAM NAME> — a friendly first: our endpoints, our terms, both digests, and
...
| Counted series played | **4** — see below |
...
Two roles, two repositories, two processes, always. Nothing is shared between them at runtime
    ...
    cop commit   a4e0bcdcf3712ee444bd5cdc6d22d35567e2245c   (branch main)

    thief repo   https://github.com/Diana-Koroblov/bestteam-thief
    thief commit 273fad65cd080aa19dc1a4a4915fa5830ffe7c6d   (branch main)

Both public, both resolving, both clones clean against `origin/main`. **We declare published
...
**We have played four counted series, every one six sub-games of six, and lost all four:**

    imreeyal   2026-08-18   40 - 60
    vibecode   2026-08-19   30 - 90
    nis-yar1   2026-08-19   30 - 90
    yanell11   2026-08-24   30 - 90

Roles alternated in all four, with us as cop on the odd sub-games. Every audit settled, every
report went to the lecturer, and both opponents' files agree with ours.

So unless you are one of those four, **this would be our fifth counted series and our fifth
...
We will also say the obvious thing about those four scorelines rather than let you discover it:
we have not won a counted series yet, and three of the four finished 30-90. You are not walking into a trap. What we can promise is
that the protocol side is thoroughly exercised — all four series settled 6/6 with every
commitment re-hashed and no dispute about a single sub-game. Every sub-game of the first two
still re-verifies off disk today, both sides of each, straight from the filed logs.
...
`roles` keyed by **group id**, not by role name — `{"bestteam": "police", "<TEAM NAME>": "thief"}`.
